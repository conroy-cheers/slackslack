...
async function main() {
  ...
  await runLogged(
    ...
    [
      "-lc",
      "nix shell nixpkgs#wasm-pack nixpkgs#binaryen nixpkgs#lld -c bash -lc 'cd /home/conroy/src/slackslack/crates/emoji-web && wasm-pack build --target web --out-dir static/pkg'",
    ],
    repoRoot,
  );
